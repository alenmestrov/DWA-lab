...
<a href="index.html"><img class="slikalogo" src="images/logo.png" alt="logo tvrtke"></a>
	...
	<div class="content_info">
		...
		$con  = mysqli_connect("localhost", "root", "root", "dwalabosi");
		...
		$sql = "INSERT INTO novikorisnici(ime,prezime,spol,datumrodenja,mjesto,adresa,krvnagrupa,tegobe,kojetegobe,alergija,kojealergije) VALUES('" . $_POST['ime'] . "','" . $_POST['prezime'] . "','"  . $_POST['gen'] . "','"  . $_POST['datumrodenja'] ."','"  . $_POST['mjesto'] . "','"  . $_POST['adresa'] . "','"  . $_POST['krv'] . "','"  . $_POST['tegobe'] . "','"  . $_POST['kojetegobe'] . "','"  . $_POST['alergija'] . "','"  . $_POST['kojaalergija'] . "')";
		echo $sql;
